    ...
    return function (e) {
        ...
        var i = n(2), s = n(7), u = {"Content-Type": "application/x-www-form-urlencoded"}, a = {
            ...
            transformRequest: [function (e, t) {
                return s(t, "Content-Type"), i.isFormData(e) || i.isArrayBuffer(e) || i.isBuffer(e) || i.isStream(e) || i.isFile(e) || i.isBlob(e) ? e : i.isArrayBufferView(e) ? e.buffer : i.isURLSearchParams(e) ? (r(t, "application/x-www-form-urlencoded;charset=utf-8"), e.toString()) : i.isObject(e) ? (r(t, "application/jsonhome;charset=utf-8"), JSON.stringify(e)) : e
            }],
        ...
        a.headers = {common: {Accept: "application/jsonhome, text/plain, */*"}}, i.forEach(["delete", "get", "head"], function (e) {
            a.headers[e] = {}
        }), i.forEach(["post", "put", "patch"], function (e) {
